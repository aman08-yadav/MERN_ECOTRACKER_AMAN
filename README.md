...
[🐛 Report a Bug](https://github.com/aman08-yadav/MERN_ECOTRACKER_AMAN/issues) · [✨ Request a Feature](https://github.com/aman08-yadav/MERN_ECOTRACKER_AMAN/issues) · [📖 View Docs](#api-reference)
...
git clone https://github.com/aman08-yadav/MERN_ECOTRACKER_AMAN.git
cd MERN_ECOTRACKER_AMAN
...
|------|-------------|-------------|
| 🟠 **ADMIN** | Full company access | Manage users (create, delete, assign roles) · Manage departments · Full CRUD on emission logs + bulk upload · View analytics, reports & export data · Update company profile |
| 🟡 **EXECUTIVE** | Analytics & reporting access | View analytics dashboards · Generate & export reports |
| 🟢 **EMPLOYEE** | Department-scoped data entry | Create, edit, delete own emission logs · Bulk upload emission data via CSV · View personal dashboard |
